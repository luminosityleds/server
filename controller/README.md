...
2. Generate documentation with `sphinx-build -b html docs/source/ docs/build/html`
3. Open `docs/build/html/index.html` in a web browser and you should Sphinx documentation. 